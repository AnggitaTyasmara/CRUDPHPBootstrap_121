                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="NIM" placeholder="Masukkan Nim Siswa" name="nim" required>
                        </div>
                        <div class="mb-3">
                            <!-- input alamat -->
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea type="text" class="form-control" id="Alamat" placeholder="Masukkan Alamat Siswa" name="alamat" required></textarea>
                        </div>
                        <!-- akhir form control -->
                    </div>
